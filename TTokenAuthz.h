...
class TTokenAuthz {
  ...
  */
  ...
  TTokenAuthz(const char* name=0,bool verbose=false, std::string authzpath = "");
...
5A     the class destructor
  ...
  */
  ...
  static TTokenAuthz* GetTokenAuthz(const char* name=0, bool verbose=false, std::string authzpath = "");
