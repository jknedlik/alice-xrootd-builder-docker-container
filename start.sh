...
docker build --tag xrootdbuilder-$DEB_VER:0.1 --tag xrootdbuilder-$DEB_VER:latest --build-arg XRD_VER="4.8.4" --build-arg DEB_VER="debian:$DEB_VER" --build-arg ADDITIONAL_VERSION_STRING="-gsi-2" .
